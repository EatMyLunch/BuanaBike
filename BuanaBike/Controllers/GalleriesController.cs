...
namespace BuanaBike.Controllers
{
    public class GalleriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Url,Title,DateCreated")] Gallery gallery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Url,Title,DateCreated")] Gallery gallery)
        {
            if (id != gallery.Id)
            {
                return NotFound();
